 ...
 */
export function setupDevice(selectElement, outputElement) {
...
export function setupTare(element) {
    element.addEventListener("click", () => {
        device?.tare();
    });
}
export function setupDifficulty(element) {
...
export function setupWeight(element) {
    element.addEventListener("change", () => {
...
const Game = {
    ...
    context: null,
    player: {}, // Temporary initialization
    paddle: {}, // Temporary initialization
    ball: {}, // Temporary initialization
    running: false,
    over: false,
    turn: null,
    timer: 0,
